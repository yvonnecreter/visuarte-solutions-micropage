        ...
        {desktop ? (
          ...
          opacity:"1"
                    ...
                    >
                      ...
                      >
                        <defs>
    <pattern id="pattern0" x="0" y="0" width="15" height="15" patternUnits="userSpaceOnUse">
      <circle cx="3" cy="3" r="3" fill= {colors[0]} />
    </pattern>
    <pattern id="pattern1" x="0" y="0" width="15" height="15" patternUnits="userSpaceOnUse">
      <circle cx="3" cy="3" r="3" fill= {colors[1]} />
    </pattern>
    <pattern id="pattern2" x="0" y="0" width="15" height="15" patternUnits="userSpaceOnUse">
      <circle cx="3" cy="3" r="3" fill= {colors[2]} />
    </pattern>
  </defs>
