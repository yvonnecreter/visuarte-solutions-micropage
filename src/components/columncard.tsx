...
export default function ColumnCard() {
  ...
  return (
        ...
        {desktop ? (
          ...
          opacity:"1"
                    ...
                    >
                      ...
                      >
                        <defs>
    {/* <pattern id="pattern0" patternUnits="userSpaceOnUse" width="60" height="60"> */}
    {/* <rect width="16" height="16" fill={colors[0]}>
      </rect> */}
      {/* <g transform="scale(0.45)" fill={colors[0]}>
      <path d="M56.6669 100H43.3335V66.0945L19.3585 90.0696L9.93037 80.6415L33.9054 56.6666H0V43.3332H33.9049L9.93025 19.3586L19.3583 9.9305L43.3335 33.9057V0H56.6669V33.905L80.6411 9.93075L90.0692 19.3589L66.0949 43.3332H100V56.6665H66.0944L90.069 80.6411L80.6409 90.0692L56.6669 66.0953V100Z" fill-rule="evenodd" clip-rule="evenodd">
      </path>
      </g> */}
    <pattern id="pattern0" patternUnits="userSpaceOnUse" /* width="18" height="18"> */width="28" height="28">
    {/* <rect width="16" height="16" fill= {colors[0]} /> */}
    ...
    <path d="M-1,1 l2,-2
           M0,4 l4,-4
           M3,5 l2,-2" 
        stroke="#5b5b5b" stroke-width="0.13" opacity="0.6"/></g>
    </pattern>
    <pattern id="pattern1" patternUnits="userSpaceOnUse" width="28" height="28">
    ...
    <pattern id="pattern2" patternUnits="userSpaceOnUse" width="28" height="28">
    <rect x="0" y="0" width="100%" height="100%" fill={colors[2]}/>
    {/*< rect width="16" height="16" fill= {colors[2]} /> */}
    <g transform="scale(7)">
    <path d="M-1,1 l2,-2
           M0,4 l4,-4
           M3,5 l2,-2" 
        stroke="#5b5b5b" stroke-width="0.13" opacity="0.6"/> </g>
                          ...
                          <g>
                            ...
                            <g>
                              ...
                              <path
                                ...
                                fill="url(#pattern0)"/* stroke-width={strokeW}
                  /* fill="transparent" */
                              />
                              <path
                  ...
                  fill="transparent" */
                              ...
                              <path
                                ...
                                fill="url(#pattern2)"/* stroke-width={strokeW}
                  fill="transparent" */
                              />
                              {/* screen links */}
                              <path
                                ...
                                fill="url(#pattern1)" /* stroke-width={strokeW}
                  fill="transparent" */
                              />
                              {/* touchscreen */}
                              <path
                  ...
                  fill="transparent" */
                    ...
                    ><defs>
                      <pattern id="patternGrey" x="0" y="0" width="14" height="14" patternUnits="userSpaceOnUse">
